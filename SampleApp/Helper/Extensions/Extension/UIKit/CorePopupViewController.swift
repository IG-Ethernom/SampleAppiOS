...
protocol CorePopupViewControllerDelegate: AnyObject {
    /// It is called when pop up is dismissed by tap outside
    func popupViewControllerDidDismiss(sender: CorePopupViewController)
}

// optional func
extension CorePopupViewControllerDelegate {
    func popupViewControllerDidDismiss(sender: CorePopupViewController) {}
}

public class CorePopupViewController: UIViewController {
    ...
    weak var delegate: CorePopupViewControllerDelegate?
...
extension CorePopupViewController: UIGestureRecognizerDelegate {
